...
print(scipy.stats.ks_2samp(img_all[:,:,:,:].mean(-1).mean(-1).flatten().detach().cpu().numpy(), img_allSur1[:,:,:,:].mean(-1).mean(-1).flatten().detach().cpu().numpy()))
print(scipy.stats.ks_2samp(img_all[:,:,:,:].mean(-1).mean(-1).flatten().detach().cpu().numpy(), img_allSur2[:,:,:,:].mean(-1).mean(-1).flatten().detach().cpu().numpy()))
